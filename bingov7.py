...
class Game(tk.Toplevel):
  def __init__(self, parent):
    ...
    numButtons = 32
    photos = ["esca.png", "luna.png", "sol.png", "bandera.png", "melon.png", "camaron.png", "bota.png", "cotorro.png", "arana.png", "tambor.png", "corazon.png", "sanda.png", "estrella.png", "mundo.png", "alacran.png", "nopal.png", "musico.png", "pajaro.png", "arbol.png", "muerte.png", "diablo.png", "catrin.png", "dama.png", "barril.png", "bando.png", "rosa.png", "cala.png", "rana.png", "arpa.png", "chalupa.png", "corona.png", "pesc.png"]
    ...
    freespace = tk.Button(self, image= randpic(12), height= 67, width = 54, command = lambda: clicked(self, freespace))
    freespace.grid(row = 5, column = 1)
    ...
    def clicked(self, button):
      if button == button1:
        if button1['image'] == testlbl['image']:
          ...
          clickedbs.append("b1")
        if clickedbs.count("b1") > 0 and clickedbs.count("b2") > 0 and clickedbs.count("b3") > 0 and clickedbs.count("b4") > 0 or clickedbs.count("b1") > 0 and clickedbs.count("b5") > 0 and clickedbs.count("b9") > 0 and clickedbs.count("free") > 0 or clickedbs.count("b1") > 0 and clickedbs.count("b6") > 0 and clickedbs.count("b11") > 0 and clickedbs.count("b16") > 0:
      ...
      if button == button4:
        if button4['image'] == testlbl['image']:
          ...
          clickedbs.append("b4")
        if clickedbs.count("b1") > 0 and clickedbs.count("b2") > 0 and clickedbs.count("b3") > 0 and clickedbs.count("b4") > 0 or clickedbs.count("b4") > 0 and clickedbs.count("b8") > 0 and clickedbs.count("b12") > 0 and clickedbs.count("b16") > 0 or clickedbs.count("b4") and clickedbs.count("b7") and clickedbs.count("b10") and clickedbs.count("free"):
          tk.messagebox.showinfo(parent = self, title = "¡Lotería!", message = "You win!")
          #
      if button == button5:
        if button5['image'] == testlbl['image']:
          ...
          clickedbs.append("b5")
        if clickedbs.count("b5") > 0 and clickedbs.count("b6") > 0 and clickedbs.count("b7") > 0 and clickedbs.count("b8") > 0 or clickedbs.count("b1") > 0 and clickedbs.count("b5") > 0 and clickedbs.count("b9") > 0 and clickedbs.count("free") > 0:
          tk.messagebox.showinfo(parent = self, title = "¡Lotería!", message = "You win!")   
      ...
      if button == button7:
        if button7['image'] == testlbl['image']:
          ...
          clickedbs.append("b7")
        if clickedbs.count("b5") > 0 and clickedbs.count("b6") > 0 and clickedbs.count("b7") > 0 and clickedbs.count("b8") > 0 or clickedbs.count("b3") > 0 and clickedbs.count("b7") > 0 and clickedbs.count("b11") > 0 and clickedbs.count("b15") > 0 or clickedbs.count("b4") > 0 and clickedbs.count("b7") > 0 and clickedbs.count("b10") > 0 and clickedbs.count("free") > 0:
          tk.messagebox.showinfo(parent = self, title = "¡Lotería!", message = "You win!")
      if button == button8:
      ...
      if button == button9:
        if button9['image'] == testlbl['image']:
          ...
          clickedbs.append("b9")
        if clickedbs.count("b9") > 0 and clickedbs.count("b10") > 0 and clickedbs.count("b11") > 0 and clickedbs.count("b12") > 0 or clickedbs.count("b1") > 0 and clickedbs.count("b5") > 0 and clickedbs.count("b9") > 0 and clickedbs.count("free") > 0:
          tk.messagebox.showinfo(parent = self, title = "¡Lotería!", message = "You win!")
      if button == button10:
        if button10['image'] == testlbl['image']:
          button10.configure(bg = mark)
          clickedbs.append("b10")
        if clickedbs.count("b9") > 0 and clickedbs.count("b10") > 0 and clickedbs.count("b11") > 0 and clickedbs.count("b12") > 0 or clickedbs.count("b2") > 0 and clickedbs.count("b6") > 0 and clickedbs.count("b10") > 0 and clickedbs.count("b14") > 0 or clickedbs.count("b4") > 0 and clickedbs.count("b7") > 0 and clickedbs.count("b10") > 0 and clickedbs.count("free") > 0:
          tk.messagebox.showinfo(parent = self, title = "¡Lotería!", message = "You win!")
      ...
      if button == button12:
        ...
        if clickedbs.count("b9") > 0 and clickedbs.count("b10") > 0 and clickedbs.count("b11") > 0 and clickedbs.count("b12") > 0 or clickedbs.count("b4") > 0 and clickedbs.count("b8") > 0 and clickedbs.count("b12") > 0 and clickedbs.count("b16") > 0:
          tk.messagebox.showinfo(parent = self, title = "¡Lotería!", message = "You win!")
      if button == freespace:
        if freespace['image'] == testlbl['image']:
          freespace.configure(bg = mark)
          clickedbs.append("free")
        if clickedbs.count("free") > 0 and clickedbs.count("b14") > 0 and clickedbs.count("b15") > 0 and clickedbs.count("b16") > 0 or clickedbs.count("b1") > 0 and clickedbs.count("b5") > 0 and clickedbs.count("b9") > 0 and clickedbs.count("free") > 0 or clickedbs.count("b4") > 0 and clickedbs.count("b7") > 0 and clickedbs.count("b10") > 0 and clickedbs.count("free") > 0:
          tk.messagebox.showinfo(parent = self, title = "¡Lotería!", message = "You win!")
      if button == button14:
        if button14['image'] == testlbl['image']:
          button14.configure(bg = mark)
          clickedbs.append("b14")
        if clickedbs.count("free") > 0 and clickedbs.count("b14") > 0 and clickedbs.count("b15") > 0 and clickedbs.count("b16") > 0 or clickedbs.count("b2") > 0 and clickedbs.count("b6") > 0 and clickedbs.count("b10") > 0 and clickedbs.count("b14") > 0:
          tk.messagebox.showinfo(parent = self, title = "¡Lotería!", message = "You win!")
      if button == button15:
        if button15['image'] == testlbl['image']:
          button15.configure(bg = mark)
          clickedbs.append("b15")
        if clickedbs.count("free") > 0 and clickedbs.count("b14") > 0 and clickedbs.count("b15") > 0 and clickedbs.count("b16") > 0 or clickedbs.count("b3") > 0 and clickedbs.count("b7") > 0 and clickedbs.count("b11") > 0 and clickedbs.count("b15") > 0:
          tk.messagebox.showinfo(parent = self, title = "¡Lotería!", message = "You win!")
      if button == button16:
        if button16['image'] == testlbl['image']:
          button16.configure(bg = mark)
          clickedbs.append("b16")
        if clickedbs.count("free") > 0 and clickedbs.count("b14") > 0 and clickedbs.count("b15") > 0 and clickedbs.count("b16") > 0 or clickedbs.count("b4") > 0 and clickedbs.count("b8") > 0 and clickedbs.count("b12") > 0 and clickedbs.count("b16") > 0 or  clickedbs.count("b1") > 0 and clickedbs.count("b6") > 0 and clickedbs.count("b11") > 0 and clickedbs.count("b16") > 0:
          tk.messagebox.showinfo(parent = self, title = "¡Lotería!", message = "You win!")
        print(clickedbs)
